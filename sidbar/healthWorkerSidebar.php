...
<aside class="fixed top-0 left-0 h-full w-64 bg-teal text-white shadow-xl z-50 flex flex-col no-print" id="sidebar">
    ...
    <div class="p-5 border-b border-white/20">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <span class="text-xs text-white/70">Health Worker</span>
            </div>
        </div>
    </div>
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        <p class="text-xs text-white/50 uppercase tracking-wider px-3 mt-4 mb-2">Patient Care</p>
        <a href="manage_patients.php" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm <?= $current_page == 'manage_patients.php' ? 'bg-white/15 border-l-3 border-orange' : 'hover:bg-white/10' ?>">
            <i class="fas fa-hospital-user w-5 text-center"></i> Patient Records
        </a>
        <a href="medical_history.php" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm <?= $current_page == 'medical_history.php' ? 'bg-white/15 border-l-3 border-orange' : 'hover:bg-white/10' ?>">
            <i class="fas fa-notes-medical w-5 text-center"></i> Medical History
        </a>
        <a href="treatments.php" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm <?= $current_page == 'treatments.php' ? 'bg-white/15 border-l-3 border-orange' : 'hover:bg-white/10' ?>">
            <i class="fas fa-stethoscope w-5 text-center"></i> Treatments
        </a>
        ...
        <p class="text-xs text-white/50 uppercase tracking-wider px-3 mt-4 mb-2">Health Programs</p>
        <a href="dispensed_medicines.php" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm <?= $current_page == 'dispensed_medicines.php' ? 'bg-white/15 border-l-3 border-orange' : 'hover:bg-white/10' ?>">
            <i class="fas fa-pills w-5 text-center"></i> Dispense Medicine
        </a>
    ...
    <div class="p-4 border-t border-white/20">
        <div class="flex items-center gap-3 mb-3">
            ...
            <div class="flex-1 min-w-0">
                ...
                <p class="text-xs text-white/60">Health Worker</p>
            </div>
        </div>
